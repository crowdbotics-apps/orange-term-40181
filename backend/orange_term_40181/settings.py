"""
Django settings for orange_term_40181 project.
...
ROOT_URLCONF = 'orange_term_40181.urls'
...
WSGI_APPLICATION = 'orange_term_40181.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "orange_term_40181 API",
    "DESCRIPTION": "API documentation for orange_term_40181 App",
    "VERSION": "v1",
}
